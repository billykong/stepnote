...
event1 = FactoryGirl.create(:event,
	...
	:thumbnail => File.new("#{Rails.root}/db/seed_data/_station.jpg"),
	lat: 24.468177,
	lng: 118.115499,
...
event2 = FactoryGirl.create(:event,
	...
	:thumbnail => File.new("#{Rails.root}/db/seed_data/_hotel.jpg"),
	lat: 24.450870,
	lng: 118.082650,
	itinerary_id: itinerary1.id)
event3 = FactoryGirl.create(:event,
	...
	:thumbnail => File.new("#{Rails.root}/db/seed_data/_city.jpg"),
	lat: 24.450900,
	lng: 118.083650,
	itinerary_id: itinerary1.id)
event4 = FactoryGirl.create(:event,
	...
	thumbnail: File.new("#{Rails.root}/db/seed_data/_cafe.jpg"),
	lat: 24.450920,
	lng: 118.082700,
	itinerary_id: itinerary1.id)
event5 = FactoryGirl.create(:event,
	...
	thumbnail: File.new("#{Rails.root}/db/seed_data/_river.jpg"),
	lat: 24.451000,
	lng: 118.082650,
	itinerary_id: itinerary1.id)
